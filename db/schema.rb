...
ActiveRecord::Schema.define(version: 20140425164442) do
  ...
  create_table "design_assignments", force: true do |t|
    t.integer  "design_id"
    t.integer  "design_plant_id"
    t.integer  "design_planter_id"
    t.integer  "user_id"
    t.boolean  "included"
    t.integer  "quantity"
